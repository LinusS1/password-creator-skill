...
class PasswordCreator(MycroftSkill):
    ...
    @intent_handler(IntentBuilder("CreatePassword").require("Create").require("Password").optionally("NumberOfWords"))
    def handle_creator_password(self, message):
        ...
        password = xp.generate_xkcdpassword(words, number_of_words)  # Can modify
